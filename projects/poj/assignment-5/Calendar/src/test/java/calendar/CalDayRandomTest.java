...
public class CalDayRandomTest {
	...
	public static String RandomSelectMethod(Random random){
		String[] methodArray = new String[] {"addAppointment"};// The list of the of methods to be tested in the Appt class
	  ...
	  public void radnomtest()  throws Throwable  {
		 ...
		 try {
			 for (int iteration = 0; elapsed < TestTimeout; iteration++) {
				 ...
				 int startHour2 = ValuesGenerator.getRandomIntBetween(random, -1, 26);
				 ...
				 for (int i = 0; i < NUM_TESTS; i++) {
					 ...
					 if (methodName.equals("addAppointment")){
